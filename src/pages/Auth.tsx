...
export default function Auth() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col md:flex-row">
      ...
      <div className="hidden md:flex md:w-1/2 items-center justify-center p-8 bg-[#7599ff]">
      ...
      <div className="w-full md:w-1/2 flex items-center justify-center p-6 md:p-8 bg-white min-h-[100dvh] md:min-h-screen">
        <div className="w-full max-w-md space-y-6 md:space-y-8">
          <div className="text-center">
            {/* Logo only visible on mobile */}
            <div className="md:hidden flex justify-center mb-6">
              <img src="/lovable-uploads/87919125-83d7-4d17-aef5-c7f61a7a6efb.png" alt="Devolvi Logo" className="h-12 w-auto" />
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 md:h-10 bg-primary hover:bg-primary/90" 
              disabled={loading}
            >
              {loading 
